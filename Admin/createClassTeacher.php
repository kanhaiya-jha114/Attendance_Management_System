...
if(isset($_POST['save'])){
  ...
  $dateCreated = date("Y-m-d");
    ...
    values ('$firstName','$lastName','$emailAddress','$password','$phoneNo','$classId','$classArmId','$dateCreated')");
                ...
                <div class="card-body">
                  <form method="post">
                   <div class="form-group row mb-3">
                      ...
                      <input type="text" class="form-control" required name="lastName" value="<?php echo $row['lastName'];?>" id="exampleInputLastName" >
                        </div>
                    </div>
                     <div class="form-group row mb-3">
                        <div class="col-xl-6">
                        <label class="form-control-label">Email Address<span class="text-danger ml-2">*</span></label>
                        <input type="email" class="form-control" required name="emailAddress" value="<?php echo $row['emailAddress'];?>" id="exampleInputEmailAddress" >
                        </div>
                        <div class="col-xl-6">
                    ...
                    <div class="col-xl-6">
                        ...
                        <input type="password" class="form-control" required name="password" value="<?php echo $row['password'];?>" id="exampleInputPassword" >
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
