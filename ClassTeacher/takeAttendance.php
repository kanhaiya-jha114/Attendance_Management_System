...
include '../Includes/session.php';
    ...
    $rrw = $rs->fetch_assoc();
        ...
        if($count == 0){ //if Record does not exsit, insert the new record
          ...
          {
              $qquery=mysqli_query($conn,"insert into tblattendance(admissionNo,classId,classArmId,status,dateTimeTaken) 
              value('$ros[admissionNumber]','$_SESSION[classId]','$_SESSION[classArmId]','0','$dateTaken')");
